...
begin
  ...
  return public.tb810_persist_monthly_obligation_snapshot(p_building_id, p_period_year, p_period_month, p_rows, p_gas_bill_ids);
end;
$$;

create or replace function public.tb810_create_monthly_obligation_snapshot_system(
  p_building_id uuid,
  p_period_year integer,
  p_period_month integer,
  p_rows jsonb,
...
revoke execute on function public.tb810_persist_monthly_obligation_snapshot(uuid, integer, integer, jsonb, uuid[]) from public, anon, authenticated;
revoke execute on function public.tb810_create_monthly_obligation_snapshot_system(uuid, integer, integer, jsonb, uuid[]) from public, anon, authenticated;
grant execute on function public.tb810_create_monthly_obligation_snapshot_system(uuid, integer, integer, jsonb, uuid[]) to service_role;
