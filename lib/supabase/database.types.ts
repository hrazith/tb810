  ...
  public: {
    ...
    Enums: {
      ...
      tb810_credit_transfer_status:
        "pending" | "approved" | "posted" | "reversed";
      tb810_document_status:
        "draft" | "received" | "reviewed" | "approved" | "archived";
      ...
      tb810_payment_allocation_type:
        "fixed" | "water" | "common" | "credit" | "other";
      tb810_payment_status:
        "pending" | "posted" | "partially_reconciled" | "reconciled" | "void";
      tb810_role_key:
        | "super_admin"
        | "building_manager"
