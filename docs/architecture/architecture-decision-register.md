...
| WATER-009 | The Unit Meter Reading upload template is `lecturas.xlsx` | Frozen | 2026-07-31 | 2026-07-31 | [TB810 Water Domain](/Users/roon/dev/tb810/docs/tb810-water-domain.md), [Unit Meter Reading Domain](/Users/roon/dev/tb810/docs/water/02-unit-meter-reading-domain.md) | Standardizes the temporary workbook contract to `lecturas.xlsx` with worksheet `Worksheet` and required columns `Unidad` and `Lectura`; the parser normalizes `DEP-201` to `201`. |
