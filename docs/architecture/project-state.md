...
This document tracks the current implementation status of major TB810 domain areas.

Status meanings:

- Frozen: architectural direction is decided
- Discovery: architecture is still being explored
- Slice 1 Complete: the first vertical slice has been implemented
