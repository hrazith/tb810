...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      tb810_monthly_obligation_components: {
        Row: {
          amount: number | null
          building_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "tb810_monthly_obligation_components_building_id_fkey"
            columns: ["building_id"]
            isOneToOne: false
            referencedRelation: "tb810_buildings"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "tb810_monthly_obligation_components_obligation_id_fkey"
            columns: ["obligation_id"]
            isOneToOne: false
            referencedRelation: "tb810_monthly_obligations"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "tb810_monthly_obligation_components_unit_account_id_fkey"
            columns: ["unit_account_id"]
            isOneToOne: false
            referencedRelation: "tb810_unit_accounts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "tb810_monthly_obligation_components_unit_id_fkey"
            columns: ["unit_id"]
            isOneToOne: false
            referencedRelation: "tb810_units"
            referencedColumns: ["id"]
      ...
      tb810_monthly_obligations: {
        ...
        Relationships: [
          {
            foreignKeyName: "tb810_monthly_obligations_billing_period_id_fkey"
          ...
          {
            foreignKeyName: "tb810_monthly_obligations_building_id_fkey"
            columns: ["building_id"]
            isOneToOne: false
            referencedRelation: "tb810_buildings"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "tb810_monthly_obligations_unit_account_id_fkey"
            columns: ["unit_account_id"]
            isOneToOne: false
            referencedRelation: "tb810_unit_accounts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "tb810_monthly_obligations_unit_id_fkey"
            columns: ["unit_id"]
            isOneToOne: false
            referencedRelation: "tb810_units"
            referencedColumns: ["id"]
